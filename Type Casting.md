...
11. When would you use upcasting in Swift?
...
18. What happens if you try to downcast to a subclass that the instance does not belong to?
19. How can `Any` and `AnyObject` enhance the flexibility of collections in Swift?
